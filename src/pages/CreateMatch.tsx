...
export default function CreateMatch() {
  ...
  const handleTossComplete = (tossWinner: 'A' | 'B', tossCall: 'heads' | 'tails', battingFirst: 'A' | 'B') => {
    ...
    const setup: MatchSetup = {
      ...
      teamA: { name: teamAName, players: selectedTeamA.players, logoUrl: selectedTeamA.logoUrl },
      teamB: { name: teamBName, players: selectedTeamB.players, logoUrl: selectedTeamB.logoUrl },
      tossWinner,
      tossCall,
      battingFirst,
    };
